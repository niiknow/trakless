...
(function() {
  var $defaultTracker, $defaults, $pixel, $sessionid, $siteid, $trakless2, Emitter, attrs, cookie, defaults, domevent, fn, getImage, i, j, k, len, len1, mytrakless, myutil, prefix, query, ref, ref1, script, tracker, trakless, traklessParent, util, uuid, webanalyser, win, xstore;
  ...
  util = (function() {
    ...
    util.prototype.onClick = function(el, handler, monitor) {
...
}, {"xstore":2,"emitter":3,"domevent":4,"cookie":5,"defaults":6,"querystring":7,"uuid":8,"webanalyser":9}],
...
}, {"script-onload":12,"next-tick":13,"type":14}],
